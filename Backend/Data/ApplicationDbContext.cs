...
namespace CoastalPharmacyCRUD.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.HasSequence<int>("TransactionNumbers", schema: "dbo")
            .StartsAt(1)
            .IncrementsBy(1);
            ...
            modelBuilder.Entity<SYS_Transaction>(entity =>
            {
                ...
                // NumberTransaction [automatic] (1, 2, 3...) - NO CACHE
                entity.Property(e => e.NumberTransaction)
                .HasDefaultValueSql("NEXT VALUE FOR dbo.TransactionNumbers")
                .ValueGeneratedOnAdd();
            ...
            modelBuilder.HasSequence<int>("ImportHistoryNumbers", schema: "dbo")
            .StartsAt(1)
            .IncrementsBy(1);
            ...
            modelBuilder.Entity<ImportHistory>(entity =>
            {
                ...
                .HasDefaultValueSql("NEXT VALUE FOR dbo.ImportHistoryNumbers")
                .ValueGeneratedOnAdd();

                entity.HasOne(h => h.ImportUser)
                    .WithMany()
                    .HasForeignKey(h => h.ImportUserId)
                    .OnDelete(DeleteBehavior.Restrict);
            });
        }
    }
